...
public class GetRecruitmentDetailRequest extends BaseRequest{
	...
	public void responceSuccess(String jstring) {
		...
		try {
			...
			recruit.recruitmentId = getString(asJO,"recruitId");
			recruit.cityCode = getString(asJO,"cityCode");
			recruit.title = getString(asJO,"title");
			recruit.description = getString(asJO,"description");
			recruit.averagePrice = getString(asJO,"price");
			recruit.priceUnit = getString(asJO,"priceUnit");
			recruit.coverUrl = getString(asJO,"coverUrl");
			recruit.recruitType = RecruitType.getRecruitTypeByValue(getString(asJO,"recruitType"));


			recruit.userId = getString(asJO,"userId");
			recruit.imId = getString(asJO,"imId");
			recruit.avatarUrl = getString(asJO,"avatarUrl");
			recruit.nickname = getString(asJO,"v");
			recruit.gender = Gender.getGender(getString(asJO,"gender"));


			recruit.issueTimeStamp = Long.valueOf(getString(asJO, "recruitType")).longValue();

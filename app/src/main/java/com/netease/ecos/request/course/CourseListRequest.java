...
public class CourseListRequest extends BaseRequest{
	...
	//响应参数键
	CourseListRespnce mCourseListRespnce;
	
	
	public void request(CourseListRespnce courseListRespnce, final Type type, final CourseType courseType
	...
	*
	 */
	interface CourseListRespnce extends IBaseResponse{

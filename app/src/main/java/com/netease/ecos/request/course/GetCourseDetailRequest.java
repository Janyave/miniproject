...
public class GetCourseDetailRequest extends BaseRequest{
	...
	//响应参数键
	CourseDetailRespnce mCourseDetailRespnce;
	
	
	public void request(CourseDetailRespnce courseDetailRespnce, final String courseId)
	{
	...
	*
	 */
	interface CourseDetailRespnce extends IBaseResponse{

...
public class RequestUrlConstants {
	...
	/*** 获取验证码  */
	public static final String SEND_AUTO_CODE_URL = HOST + "m/authcode?";
	
	/*** 注册  */
	public static final String REGIST_URL=HOST + "/m/user/register?";
	
	/*** 登录  */
	public static final String LOLGIN_URL = HOST + "/m/user/login?";
	
	/*** 登出 */
	public static final String LOGOUT = HOST + "m/user/logout?";
	
	/*** 用户城市定位  */
	public static final String SEND_LOCATON_URL = HOST + "/m/user/location?";
	
	/*** 忘记密码  */
	public static final String RESET_PASSWORD_URL=HOST + "/m/user/pwd/reset";
	
	/*** 修改密码  */
	public static final String MODIFY_PASSWORD = HOST + "/m/user/pwd/modify";
	
	/*** 获取用户信息  */
	public static final String GET_USER_INFO = HOST + "/m/user/info?";
	
	/*** 修改用户信息  */
	public static final String UPDATE_USER_INFO = HOST + "/m/user/update?";
	
	/*** 关注其他用户  */
	public static final String FOLLOW_USER_INFO = HOST + "/m/user/follow?";
	
	/*** 获取关注的用户列表  */
	public static final String GET_FOLLED_USER_LIST = HOST + "/m/user/follow?";
